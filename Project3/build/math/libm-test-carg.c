...
static const struct test_c_f_data carg_test_data[] =
  {
    ...
    { "inf + 2.0 i", plus_infty, LIT (2.0), { 0, NON_FINITE|0 }, { 0, NON_FINITE|0 }, { 0, NON_FINITE|0 }, { 0, NON_FINITE|0 } },

    /* carg (inf + i y) == -0 for finite y < 0.  */
    { "inf - 2.0 i", plus_infty, LIT (-2.0), { minus_zero, NON_FINITE|0 }, { minus_zero, NON_FINITE|0 }, { minus_zero, NON_FINITE|0 }, { minus_zero, NON_FINITE|0 } },

    /* carg(x + i inf) == pi/2 for finite x.  */
    { "10.0 + inf i", LIT (10.0), plus_infty, { lit_pi_2_d, NON_FINITE|0 }, { lit_pi_2_d, NON_FINITE|0 }, { lit_pi_2_d, NON_FINITE|0 }, { lit_pi_2_d, NON_FINITE|0 } },

    /* carg(x - i inf) == -pi/2 for finite x.  */
    { "10.0 - inf i", LIT (10.0), minus_infty, { -lit_pi_2_d, NON_FINITE|0 }, { -lit_pi_2_d, NON_FINITE|0 }, { -lit_pi_2_d, NON_FINITE|0 }, { -lit_pi_2_d, NON_FINITE|0 } },

    /* carg (-inf + i y) == +pi for finite y > 0.  */
    { "-inf + 10.0 i", minus_infty, LIT (10.0), { lit_pi, NON_FINITE|0 }, { lit_pi, NON_FINITE|0 }, { lit_pi, NON_FINITE|0 }, { lit_pi, NON_FINITE|0 } },

    /* carg (-inf + i y) == -pi for finite y < 0.  */
    { "-inf - 10.0 i", minus_infty, LIT (-10.0), { -lit_pi, NON_FINITE|0 }, { -lit_pi, NON_FINITE|0 }, { -lit_pi, NON_FINITE|0 }, { -lit_pi, NON_FINITE|0 } },

    { "inf + inf i", plus_infty, plus_infty, { lit_pi_4_d, NON_FINITE|0 }, { lit_pi_4_d, NON_FINITE|0 }, { lit_pi_4_d, NON_FINITE|0 }, { lit_pi_4_d, NON_FINITE|0 } },

    { "inf - inf i", plus_infty, minus_infty, { -lit_pi_4_d, NON_FINITE|0 }, { -lit_pi_4_d, NON_FINITE|0 }, { -lit_pi_4_d, NON_FINITE|0 }, { -lit_pi_4_d, NON_FINITE|0 } },

    { "-inf + inf i", minus_infty, plus_infty, { lit_pi_3_m_4_d, NON_FINITE|0 }, { lit_pi_3_m_4_d, NON_FINITE|0 }, { lit_pi_3_m_4_d, NON_FINITE|0 }, { lit_pi_3_m_4_d, NON_FINITE|0 } },

    { "-inf - inf i", minus_infty, minus_infty, { -lit_pi_3_m_4_d, NON_FINITE|0 }, { -lit_pi_3_m_4_d, NON_FINITE|0 }, { -lit_pi_3_m_4_d, NON_FINITE|0 }, { -lit_pi_3_m_4_d, NON_FINITE|0 } },

    { "qNaN + qNaN i", qnan_value, qnan_value, { qnan_value, NON_FINITE|0 }, { qnan_value, NON_FINITE|0 }, { qnan_value, NON_FINITE|0 }, { qnan_value, NON_FINITE|0 } },
