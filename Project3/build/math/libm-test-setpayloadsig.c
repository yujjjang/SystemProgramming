...
static const struct test_Ff_b1_data setpayloadsig_test_data[] =
  {
    ...
    { "+0", plus_zero, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x0") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x0") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x0") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x0") } },
#else
...
#endif
    { "0x1p0", LIT (0x1p0), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x1") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x1") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x1") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x1") } },
    { "0x2p0", LIT (0x2p0), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x2") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x2") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x2") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x2") } },
    { "0x3fffffp0", LIT (0x3fffffp0), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x3fffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x3fffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x3fffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x3fffff") } },
#if PAYLOAD_DIG >= 51
    { "0x7ffffffffffffp0", LIT (0x7ffffffffffffp0), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x7ffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x7ffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x7ffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x7ffffffffffff") } },
#else
...
#endif
#if PAYLOAD_DIG >= 62
    { "0x3fffffffffffffffp0", LIT (0x3fffffffffffffffp0), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x3fffffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x3fffffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x3fffffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x3fffffffffffffff") } },
#else
...
#endif
#if PAYLOAD_DIG >= 111
    { "0x7fffffffffffffffffffffffffffp0", LIT (0x7fffffffffffffffffffffffffffp0), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x7fffffffffffffffffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x7fffffffffffffffffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x7fffffffffffffffffffffffffff") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x7fffffffffffffffffffffffffff") } },
#else
...
#endif
#if PAYLOAD_DIG >= 23
    { "0x1p22", LIT (0x1p22), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x400000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x400000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x400000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x400000") } },
#else
...
#endif
#if PAYLOAD_DIG >= 52
    { "0x1p51", LIT (0x1p51), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x8000000000000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x8000000000000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x8000000000000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x8000000000000") } },
#else
...
#endif
#if PAYLOAD_DIG >= 63
    { "0x1p62", LIT (0x1p62), { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x4000000000000000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x4000000000000000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x4000000000000000") }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED|TEST_NAN_SIGN|TEST_NAN_PAYLOAD, 1, snan_value_pl ("0x4000000000000000") } },
#else
