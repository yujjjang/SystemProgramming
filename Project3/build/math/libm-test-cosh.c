...
static const struct test_f_f_data cosh_test_data[] =
  {
    ...
    { "-inf", minus_infty, { plus_infty, NON_FINITE|ERRNO_UNCHANGED|NO_TEST_INLINE }, { plus_infty, NON_FINITE|ERRNO_UNCHANGED|NO_TEST_INLINE }, { plus_infty, NON_FINITE|ERRNO_UNCHANGED|NO_TEST_INLINE }, { plus_infty, NON_FINITE|ERRNO_UNCHANGED|NO_TEST_INLINE } },
...
#endif
#if (TEST_COND_binary32)
    { "-0x2.c5e3acp+8", LIT (-0x2.c5e3acp+8), { LIT (0xf.fffffp+124), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, NON_FINITE|OVERFLOW_EXCEPTION | ERRNO_ERANGE }, { LIT (0xf.fffffp+124), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, NON_FINITE|OVERFLOW_EXCEPTION | ERRNO_ERANGE } },
#endif
#if (TEST_COND_binary32)
    { "-0x2.c5e3bp+8", LIT (-0x2.c5e3bp+8), { LIT (0xf.fffffp+124), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, NON_FINITE|OVERFLOW_EXCEPTION | ERRNO_ERANGE }, { LIT (0xf.fffffp+124), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, NON_FINITE|OVERFLOW_EXCEPTION | ERRNO_ERANGE } },
#endif
#if (TEST_COND_binary32)
