...
static const struct test_f_f_data nextup_test_data[] =
  {
    ...
    { "max_value", max_value, { plus_infty, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { plus_infty, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { plus_infty, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { plus_infty, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    ...
    { "-inf", minus_infty, { -max_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -max_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -max_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -max_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
