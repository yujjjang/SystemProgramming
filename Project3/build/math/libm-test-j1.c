...
static const struct test_f_f_data j1_test_data[] =
  {
    ...
    { "-sNaN", -snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "inf", plus_infty, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
    { "-inf", minus_infty, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
