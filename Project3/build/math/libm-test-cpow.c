...
static const struct test_cc_c_data cpow_test_data[] =
  {
    { "qNaN + qNaN i, qNaN + qNaN i", qnan_value, qnan_value, qnan_value, qnan_value, { qnan_value, qnan_value, NON_FINITE|0 }, { qnan_value, qnan_value, NON_FINITE|0 }, { qnan_value, qnan_value, NON_FINITE|0 }, { qnan_value, qnan_value, NON_FINITE|0 } },
