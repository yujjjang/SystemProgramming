...
static const struct test_if_f_data jn_test_data[] =
  {
    ...
    { "0, -qNaN", 0, -qnan_value, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "0, sNaN", 0, snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "0, -sNaN", 0, -snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "0, inf", 0, plus_infty, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
    { "0, -inf", 0, minus_infty, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
    ...
    { "1, -qNaN", 1, -qnan_value, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "1, sNaN", 1, snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "1, -sNaN", 1, -snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "1, inf", 1, plus_infty, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
    { "1, -inf", 1, minus_infty, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },

    /* jn (3, x)  */
    { "3, qNaN", 3, qnan_value, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "3, -qNaN", 3, -qnan_value, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "3, sNaN", 3, snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "3, -sNaN", 3, -snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "3, inf", 3, plus_infty, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
    { "3, -inf", 3, minus_infty, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { minus_zero, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },

    /*  jn (10, x)  */
    { "10, qNaN", 10, qnan_value, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "10, -qNaN", 10, -qnan_value, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "10, sNaN", 10, snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "10, -sNaN", 10, -snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "10, inf", 10, plus_infty, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
    { "10, -inf", 10, minus_infty, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
