...
static const struct test_f_f_data erfc_test_data[] =
  {
    { "inf", plus_infty, { LIT (0.0), NON_FINITE|ERRNO_UNCHANGED }, { LIT (0.0), NON_FINITE|ERRNO_UNCHANGED }, { LIT (0.0), NON_FINITE|ERRNO_UNCHANGED }, { LIT (0.0), NON_FINITE|ERRNO_UNCHANGED } },
    { "-inf", minus_infty, { LIT (2.0), NON_FINITE|ERRNO_UNCHANGED }, { LIT (2.0), NON_FINITE|ERRNO_UNCHANGED }, { LIT (2.0), NON_FINITE|ERRNO_UNCHANGED }, { LIT (2.0), NON_FINITE|ERRNO_UNCHANGED } },
