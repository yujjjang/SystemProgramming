...
static const struct test_f_f_data trunc_test_data[] =
  {
    ...
    { "-min_value", -min_value, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-1", -1, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-2", -2, { -2, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -2, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -2, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -2, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-0x1p23", LIT (-0x1p23), { LIT (-0x1p23), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x1p23), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x1p23), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x1p23), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-0x1p24", LIT (-0x1p24), { LIT (-0x1p24), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x1p24), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x1p24), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x1p24), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    ...
    { "0.1", LIT (0.1), { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "0.25", LIT (0.25), { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "0.625", LIT (0.625), { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-0.1", LIT (-0.1), { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-0.25", LIT (-0.25), { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-0.625", LIT (-0.625), { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_zero, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "1", 1, { 1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-1", -1, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "1.625", LIT (1.625), { 1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-1.625", LIT (-1.625), { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },

    { "1048580.625", LIT (1048580.625), { 1048580L, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1048580L, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1048580L, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1048580L, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-1048580.625", LIT (-1048580.625), { -1048580L, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1048580L, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1048580L, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { -1048580L, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },

    { "8388610.125", LIT (8388610.125), { LIT (8388610.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (8388610.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (8388610.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (8388610.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-8388610.125", LIT (-8388610.125), { LIT (-8388610.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-8388610.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-8388610.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-8388610.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },

    { "4294967296.625", LIT (4294967296.625), { LIT (4294967296.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (4294967296.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (4294967296.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (4294967296.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-4294967296.625", LIT (-4294967296.625), { LIT (-4294967296.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-4294967296.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-4294967296.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-4294967296.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
...
# endif
    ...
    { "34503599627370498.515625", LIT (34503599627370498.515625), { LIT (34503599627370498.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (34503599627370498.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (34503599627370498.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (34503599627370498.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-34503599627370498.515625", LIT (-34503599627370498.515625), { LIT (-34503599627370498.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-34503599627370498.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-34503599627370498.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-34503599627370498.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
# if MANT_DIG >= 106
