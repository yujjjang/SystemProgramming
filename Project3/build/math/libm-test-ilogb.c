...
static const struct test_f_i_data ilogb_test_data[] =
  {
    ...
    { "qNaN", qnan_value, { FP_ILOGBNAN, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM } },
    { "-qNaN", -qnan_value, { FP_ILOGBNAN, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM } },
    { "sNaN", snan_value, { FP_ILOGBNAN, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM } },
    { "-sNaN", -snan_value, { FP_ILOGBNAN, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { FP_ILOGBNAN, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM } },
    /* ilogb (inf) == INT_MAX plus invalid exception  */
    { "inf", plus_infty, { INT_MAX, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { INT_MAX, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { INT_MAX, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { INT_MAX, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM } },
    /* ilogb (-inf) == INT_MAX plus invalid exception  */
    { "-inf", minus_infty, { INT_MAX, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { INT_MAX, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { INT_MAX, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM }, { INT_MAX, NON_FINITE|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION|ERRNO_EDOM } },
  };
