...
static const struct test_c_c_data ccos_test_data[] =
  {
    ...
    { "0.0 + inf i", LIT (0.0), plus_infty, { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 } },
    { "0.0 - inf i", LIT (0.0), minus_infty, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 } },
    { "-0 + inf i", minus_zero, plus_infty, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 } },
    { "-0 - inf i", minus_zero, minus_infty, { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 } },

    { "inf + inf i", plus_infty, plus_infty, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION } },
    { "-inf + inf i", minus_infty, plus_infty, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION } },
    { "inf - inf i", plus_infty, minus_infty, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION } },
    { "-inf - inf i", minus_infty, minus_infty, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION }, { plus_infty, qnan_value, NON_FINITE|INVALID_EXCEPTION } },

    { "4.625 + inf i", LIT (4.625), plus_infty, { minus_infty, plus_infty, NON_FINITE|0 }, { minus_infty, plus_infty, NON_FINITE|0 }, { minus_infty, plus_infty, NON_FINITE|0 }, { minus_infty, plus_infty, NON_FINITE|0 } },
    { "4.625 - inf i", LIT (4.625), minus_infty, { minus_infty, minus_infty, NON_FINITE|0 }, { minus_infty, minus_infty, NON_FINITE|0 }, { minus_infty, minus_infty, NON_FINITE|0 }, { minus_infty, minus_infty, NON_FINITE|0 } },
    ...
    { "qNaN + inf i", qnan_value, plus_infty, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 } },
    { "qNaN - inf i", qnan_value, minus_infty, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 } },
    ...
    { "0.0 + qNaN i", LIT (0.0), qnan_value, { qnan_value, LIT (0.0), NON_FINITE|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|IGNORE_ZERO_INF_SIGN } },
    { "-0 + qNaN i", minus_zero, qnan_value, { qnan_value, LIT (0.0), NON_FINITE|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|IGNORE_ZERO_INF_SIGN } },
...
#endif
#if (TEST_COND_binary32)
    { "+0 + 0x5.8cap+12 i", LIT (0x0p+0), LIT (0x5.8cap+12), { LIT (0xf.fffffp+124), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.fffffp+124), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary32)
    { "+0 + 0x5.ap+8 i", LIT (0x0p+0), LIT (0x5.ap+8), { LIT (0xf.fffffp+124), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.fffffp+124), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary32)
...
#endif
#if (TEST_COND_binary32)
    { "0x8p-152 + 0x5.8cap+12 i", LIT (0x8p-152), LIT (0x5.8cap+12), { LIT (0xf.fffffp+124), minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.fffffp+124), LIT (-0xf.fffffp+124), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0xf.fffffp+124), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary32)
    { "0x8p-152 + 0x5.ap+8 i", LIT (0x8p-152), LIT (0x5.ap+8), { LIT (0xf.fffffp+124), minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.fffffp+124), LIT (-0xf.fffffp+124), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0xf.fffffp+124), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary32)
...
#endif
#if (TEST_COND_binary32)
    { "0x8p-152 + 0xb.4p+4 i", LIT (0x8p-152), LIT (0xb.4p+4), { LIT (0xf.fffffp+124), LIT (-0x3.373468p+108), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x3.373464p+108), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.fffffp+124), LIT (-0x3.373464p+108), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x3.373464p+108), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary32)
...
#endif
#if (TEST_COND_binary64)
    { "+0 + 0x5.8cap+12 i", LIT (0x0p+0), LIT (0x5.8cap+12), { LIT (0xf.ffffffffffff8p+1020), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.ffffffffffff8p+1020), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary64)
    { "+0 + 0x5.ap+8 i", LIT (0x0p+0), LIT (0x5.ap+8), { LIT (0xf.ffffffffffff8p+1020), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.ffffffffffff8p+1020), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary64)
...
#endif
#if (TEST_COND_binary64)
    { "0x4p-1076 + 0x5.8cap+12 i", LIT (0x4p-1076), LIT (0x5.8cap+12), { LIT (0xf.ffffffffffff8p+1020), minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.ffffffffffff8p+1020), LIT (-0xf.ffffffffffff8p+1020), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0xf.ffffffffffff8p+1020), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary64)
    { "0x4p-1076 + 0x5.ap+8 i", LIT (0x4p-1076), LIT (0x5.ap+8), { LIT (0xf.ffffffffffff8p+1020), LIT (-0x5.95116a53e849cp+1000), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x5.95116a53e849cp+1000), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.ffffffffffff8p+1020), LIT (-0x5.95116a53e8498p+1000), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x5.95116a53e8498p+1000), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary64)
...
#endif
#if (TEST_COND_binary64)
    { "0x8p-152 + 0x5.8cap+12 i", LIT (0x8p-152), LIT (0x5.8cap+12), { LIT (0xf.ffffffffffff8p+1020), minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.ffffffffffff8p+1020), LIT (-0xf.ffffffffffff8p+1020), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0xf.ffffffffffff8p+1020), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary64)
    { "0x8p-152 + 0x5.ap+8 i", LIT (0x8p-152), LIT (0x5.ap+8), { LIT (0xf.ffffffffffff8p+1020), minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, minus_infty, NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.ffffffffffff8p+1020), LIT (-0xf.ffffffffffff8p+1020), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0xf.ffffffffffff8p+1020), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary64)
...
#endif
#if (TEST_COND_ibm128)
    { "0x4p-1076 + 0x5.ap+8 i", LIT (0x4p-1076), LIT (0x5.ap+8), { LIT (0xf.ffffffffffffbffffffffffffcp+1020), LIT (-0x5.95116a53e849a311fb99ee22eep+1000), NON_FINITE|((TEST_COND_ibm128_libgcc) ? XFAIL_TEST : 0) | OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x5.95116a53e849a311fb99ee22eep+1000), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.ffffffffffffbffffffffffffcp+1020), LIT (-0x5.95116a53e849a311fb99ee22ecp+1000), NON_FINITE|((TEST_COND_ibm128_libgcc) ? XFAIL_TEST : 0) | OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x5.95116a53e849a311fb99ee22ecp+1000), NON_FINITE|((TEST_COND_ibm128_libgcc) ? XFAIL_TEST : 0) | OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_ibm128)
...
#endif
#if (TEST_COND_intel96)
    { "+0 + 0x5.8cap+12 i", LIT (0x0p+0), LIT (0x5.8cap+12), { LIT (0xf.fffffffffffffffp+16380), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.fffffffffffffffp+16380), LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x0p+0), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_intel96)
...
#endif
#if (TEST_COND_intel96)
    { "0x4p-16436 + 0x5.8cap+12 i", LIT (0x4p-16436), LIT (0x5.8cap+12), { LIT (0xf.fffffffffffffffp+16380), LIT (-0x2.bf701efd42c88e8p+16356), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x2.bf701efd42c88e8p+16356), NON_FINITE|OVERFLOW_EXCEPTION }, { LIT (0xf.fffffffffffffffp+16380), LIT (-0x2.bf701efd42c88e7cp+16356), NON_FINITE|OVERFLOW_EXCEPTION }, { plus_infty, LIT (-0x2.bf701efd42c88e7cp+16356), NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_intel96)
