...
static const struct test_f_i_data signbit_test_data[] =
  {
    ...
    { "inf", plus_infty, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-inf", minus_infty, { 1, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "qNaN", qnan_value, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-qNaN", -qnan_value, { 1, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "sNaN", snan_value, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 0, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-sNaN", -snan_value, { 1, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
