...
static const struct test_c_c_data ccosh_test_data[] =
  {
    { "0.0 + inf i", LIT (0.0), plus_infty, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN } },
    { "-0 + inf i", minus_zero, plus_infty, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN } },
    { "0.0 - inf i", LIT (0.0), minus_infty, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN } },
    { "-0 - inf i", minus_zero, minus_infty, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN }, { qnan_value, LIT (0.0), NON_FINITE|INVALID_EXCEPTION|IGNORE_ZERO_INF_SIGN } },
    ...
    { "-inf + 0.0 i", minus_infty, LIT (0.0), { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 }, { plus_infty, minus_zero, NON_FINITE|0 } },
    ...
    { "-inf - 0 i", minus_infty, minus_zero, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 }, { plus_infty, LIT (0.0), NON_FINITE|0 } },
    ...
    { "-inf + 4.625 i", minus_infty, LIT (4.625), { minus_infty, plus_infty, NON_FINITE|0 }, { minus_infty, plus_infty, NON_FINITE|0 }, { minus_infty, plus_infty, NON_FINITE|0 }, { minus_infty, plus_infty, NON_FINITE|0 } },
    ...
    { "-inf - 4.625 i", minus_infty, LIT (-4.625), { minus_infty, minus_infty, NON_FINITE|0 }, { minus_infty, minus_infty, NON_FINITE|0 }, { minus_infty, minus_infty, NON_FINITE|0 }, { minus_infty, minus_infty, NON_FINITE|0 } },
    ...
    { "-inf + qNaN i", minus_infty, qnan_value, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 }, { plus_infty, qnan_value, NON_FINITE|0 } },
