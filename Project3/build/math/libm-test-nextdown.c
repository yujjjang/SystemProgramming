...
static const struct test_f_f_data nextdown_test_data[] =
  {
    ...
    { "-max_value", -max_value, { minus_infty, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "inf", plus_infty, { max_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { max_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { max_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { max_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    ...
    { "0x8.0000000000000010p-3", LIT (0x8.0000000000000010p-3), { LIT (1.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (1.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (1.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (1.0), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
#endif
#if TEST_COND_intel96
    { "-0x0.fffffffdfffffffep-16382", LIT (-0x0.fffffffdfffffffep-16382), { LIT (-0x0.fffffffep-16382), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x0.fffffffep-16382), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x0.fffffffep-16382), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x0.fffffffep-16382), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
#endif
#if TEST_COND_m68k96
    { "-0x0.fffffffdfffffffep-16383", LIT (-0x0.fffffffdfffffffep-16383), { LIT (-0x0.fffffffep-16383), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x0.fffffffep-16383), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x0.fffffffep-16383), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { LIT (-0x0.fffffffep-16383), NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
#endif
#if TEST_COND_ibm128
