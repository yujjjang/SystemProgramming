...
static const struct test_c_f_data cabs_test_data[] =
  {
    ...
    /* cabs (+inf + i x) == +inf.  */
    { "inf + 1.0 i", plus_infty, LIT (1.0), { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 } },
    /* cabs (-inf + i x) == +inf.  */
    { "-inf + 1.0 i", minus_infty, LIT (1.0), { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 } },

    { "-inf + qNaN i", minus_infty, qnan_value, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 } },
    { "-inf + qNaN i", minus_infty, qnan_value, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 }, { plus_infty, NON_FINITE|0 } },
...
#endif
#if (TEST_COND_binary32)
    { "-0x1.133b84p+84 - 0xf.fffffp+124 i", LIT (-0x1.133b84p+84), LIT (-0xf.fffffp+124), { LIT (0xf.fffffp+124), NON_FINITE|ERRNO_UNCHANGED }, { LIT (0xf.fffffp+124), NON_FINITE|ERRNO_UNCHANGED }, { LIT (0xf.fffffp+124), NON_FINITE|ERRNO_UNCHANGED }, { plus_infty, NON_FINITE|OVERFLOW_EXCEPTION } },
#endif
#if (TEST_COND_binary32)
