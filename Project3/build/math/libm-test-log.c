...
static const struct test_f_f_data log_test_data[] =
  {
    { "0", 0, { minus_infty, NON_FINITE|DIVIDE_BY_ZERO_EXCEPTION|ERRNO_ERANGE }, { minus_infty, NON_FINITE|DIVIDE_BY_ZERO_EXCEPTION|ERRNO_ERANGE }, { minus_infty, NON_FINITE|DIVIDE_BY_ZERO_EXCEPTION|ERRNO_ERANGE }, { minus_infty, NON_FINITE|DIVIDE_BY_ZERO_EXCEPTION|ERRNO_ERANGE } },
    { "-0", minus_zero, { minus_infty, NON_FINITE|DIVIDE_BY_ZERO_EXCEPTION|ERRNO_ERANGE }, { minus_infty, NON_FINITE|DIVIDE_BY_ZERO_EXCEPTION|ERRNO_ERANGE }, { minus_infty, NON_FINITE|DIVIDE_BY_ZERO_EXCEPTION|ERRNO_ERANGE }, { minus_infty, NON_FINITE|DIVIDE_BY_ZERO_EXCEPTION|ERRNO_ERANGE } },

    { "-1", -1, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM } },
    { "-min_subnorm_value", -min_subnorm_value, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM } },
    { "-min_value", -min_value, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM } },
    { "-max_value", -max_value, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM }, { qnan_value, NON_FINITE|INVALID_EXCEPTION|ERRNO_EDOM } },
    ...
    { "inf", plus_infty, { plus_infty, NON_FINITE|ERRNO_UNCHANGED }, { plus_infty, NON_FINITE|ERRNO_UNCHANGED }, { plus_infty, NON_FINITE|ERRNO_UNCHANGED }, { plus_infty, NON_FINITE|ERRNO_UNCHANGED } },
