...
static const struct test_f_f_data j0_test_data[] =
  {
    ...
    { "-inf", minus_infty, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN }, { 0, NON_FINITE|ERRNO_UNCHANGED|IGNORE_ZERO_INF_SIGN } },
