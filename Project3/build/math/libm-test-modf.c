...
static const struct test_fF_f1_data modf_test_data[] =
  {
    { "inf", plus_infty, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, plus_infty }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, plus_infty }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, plus_infty }, { 0, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, plus_infty } },
    { "-inf", minus_infty, { minus_zero, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, minus_infty }, { minus_zero, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, minus_infty }, { minus_zero, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, minus_infty }, { minus_zero, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, minus_infty } },
    { "qNaN", qnan_value, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, qnan_value }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, qnan_value }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, qnan_value }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, qnan_value } },
    { "-qNaN", -qnan_value, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, qnan_value }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, qnan_value }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, qnan_value }, { qnan_value, NON_FINITE|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED, 1, qnan_value } },
    { "sNaN", snan_value, { qnan_value, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION, 1, qnan_value }, { qnan_value, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION, 1, qnan_value }, { qnan_value, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION, 1, qnan_value }, { qnan_value, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION, 1, qnan_value } },
    { "-sNaN", -snan_value, { qnan_value, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION, 1, qnan_value }, { qnan_value, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION, 1, qnan_value }, { qnan_value, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION, 1, qnan_value }, { qnan_value, NON_FINITE|TEST_SNAN|NO_INEXACT_EXCEPTION|INVALID_EXCEPTION, 1, qnan_value } },
