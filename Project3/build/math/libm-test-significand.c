...
static const struct test_f_f_data significand_test_data[] =
  {
    ...
    /* significand returns the mantissa of the exponential
       ...
       specification.  */
    { "qNaN", qnan_value, { qnan_value, NON_FINITE|INVALID_EXCEPTION_OK }, { qnan_value, NON_FINITE|INVALID_EXCEPTION_OK }, { qnan_value, NON_FINITE|INVALID_EXCEPTION_OK }, { qnan_value, NON_FINITE|INVALID_EXCEPTION_OK } },
    { "-qNaN", -qnan_value, { qnan_value, NON_FINITE|INVALID_EXCEPTION_OK }, { qnan_value, NON_FINITE|INVALID_EXCEPTION_OK }, { qnan_value, NON_FINITE|INVALID_EXCEPTION_OK }, { qnan_value, NON_FINITE|INVALID_EXCEPTION_OK } },
    ...
    { "-sNaN", -snan_value, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION }, { qnan_value, NON_FINITE|TEST_SNAN|INVALID_EXCEPTION } },
    { "inf", plus_infty, { plus_infty, NON_FINITE|INVALID_EXCEPTION_OK }, { plus_infty, NON_FINITE|INVALID_EXCEPTION_OK }, { plus_infty, NON_FINITE|INVALID_EXCEPTION_OK }, { plus_infty, NON_FINITE|INVALID_EXCEPTION_OK } },
    { "-inf", minus_infty, { minus_infty, NON_FINITE|INVALID_EXCEPTION_OK }, { minus_infty, NON_FINITE|INVALID_EXCEPTION_OK }, { minus_infty, NON_FINITE|INVALID_EXCEPTION_OK }, { minus_infty, NON_FINITE|INVALID_EXCEPTION_OK } },
